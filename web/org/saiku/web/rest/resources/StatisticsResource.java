...
public class StatisticsResource {
	...
	// PatternLayout("%d{ISO8601} %p - %m%n"), writer);
...
//			int statementCurrentlyExecutingCount = server.statementCurrentlyExecutingCount();
			/**
			 * 解决中文乱码 使用 mondrian3.7.x版本的jar包 ，引起方法名称不同
			 */
			...
			int sqlStatementCurrentlyOpenCount = server.getStatementCurrentlyOpenCount();
			...
			return new MondrianStats(server, mv, statementCurrentlyOpenCount, connectionCurrentlyOpenCount,
					sqlStatementCurrentlyOpenCount, statementCurrentlyExecutingCount, avgCellDimensionality,
