...
public class PdfReport {
	...
	public void populatePdf(Document doc, PdfWriter writer, QueryResult qr) throws Exception {
		...
		// HTML
		MagusXMLWorkerFontProvider fontProvider = new MagusXMLWorkerFontProvider();
 ...
 * 
 */
class MagusXMLWorkerFontProvider extends XMLWorkerFontProvider {
	public Font getFont(final String fontname, final String encoding, final boolean embedded, final float size, final int style, final BaseColor color) {
		BaseFont bf = null;
		try {
			bf = BaseFont.createFont("fonts/DENG.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
